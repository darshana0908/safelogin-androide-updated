...
class SpacialNotesRead extends StatefulWidget {
  const SpacialNotesRead({Key? key}) : super(key: key);

  @override
  State<SpacialNotesRead> createState() => _SpacialNotesReadState();
}

class _SpacialNotesReadState extends State<SpacialNotesRead> {
